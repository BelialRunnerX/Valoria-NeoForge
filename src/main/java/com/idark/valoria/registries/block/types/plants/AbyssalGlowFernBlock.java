...
public class AbyssalGlowFernBlock extends GrowingPlantHeadBlock{
    public static final com.mojang.serialization.MapCodec<AbyssalGlowFernBlock> CODEC = simpleCodec(AbyssalGlowFernBlock::new); // PORT NOTE: BlockBehaviour#codec() is abstract in 1.21
    @Override protected com.mojang.serialization.MapCodec<? extends AbyssalGlowFernBlock> codec(){ return CODEC; }
