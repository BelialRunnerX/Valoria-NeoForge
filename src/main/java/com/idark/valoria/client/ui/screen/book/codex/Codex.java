...
public class Codex extends DotScreen{
    ...
    protected void init() {
        ...
        if (!isSidebarDisabled()){
            ...
            if (isAdmin) {
                // PORT NOTE: the texture-region ImageButton constructor is gone; LegacyImageButton reproduces it.
                this.addRenderableWidget(new com.idark.valoria.client.ui.widget.LegacyImageButton(this.width / 2 - 205, 20, 200, 40, 0, 0, 40, Valoria.loc("textures/gui/progression.png"), 200, 80, (button) -> {
    ...
    **/
    ...
    private void renderSkybox(float pitch, float yaw) {
        ...
        // PORT NOTE: RenderSystem#getModelViewStack is a JOML Matrix4fStack in 1.21 (pushMatrix/identity/rotate/popMatrix).
