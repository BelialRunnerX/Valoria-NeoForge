...
/**
 * PORT NOTE: Forge's IPlantable/PlantType were removed in NeoForge 21 (the "beach" plant type only gated
 * {@code canSustainPlant}, which is now the block's own {@code mayPlaceOn}); {@code canPlaceLiquid} gained a player
 * parameter.
 */
public class TallWaterFlowerBlock extends DoublePlantBlock implements SimpleWaterloggedBlock{
    ...
    protected boolean mayPlaceOn(BlockState state, BlockGetter worldIn, BlockPos pos){
        ...
        return block == Blocks.GRASS_BLOCK || block == Blocks.DIRT || block == Blocks.SAND || block == Blocks.GRAVEL || block == Blocks.PODZOL;
    }
