...
public class ModBiomeModifiers {
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(ADD_PYRATITE_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.IS_VALORIA),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.pyratiteOrePlaced)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));
        context.register(ADD_WICKED_AMETHYST_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.IS_VALORIA),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.wickedAmethystOrePlaced)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));
        context.register(ADD_PEARLIUM_ORE, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.IS_VALORIA),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.pearliumOrePlaced)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));
        context.register(ADD_DORMANT_CRYSTALS, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.IS_VALORIA),
        ...
        context.register(ADD_LONG_POT, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_SMALL_POT, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.POT_SPAWN_BIOMES),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.smallPotPlaced)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));
        
        context.register(ADD_CAVE_POT_SMALL, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.POT_SPAWN_BIOMES),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.cavePotSmallPlaced)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));

        context.register(ADD_CAVE_POT_LONG, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.POT_SPAWN_BIOMES),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.cavePotLongPlaced)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));

        context.register(ADD_DEEPSLATE_POT_SMALL, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.POT_SPAWN_BIOMES),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.deepslatePotSmallPlaced)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));

        context.register(ADD_DEEPSLATE_POT_LONG, new BiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(TagsRegistry.POT_SPAWN_BIOMES),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.deepslatePotLongPlaced)),
                GenerationStep.Decoration.UNDERGROUND_ORES
        ));

        context.register(ADD_DESERT_POT, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_SWAMP_POT, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ADD_SPAWN_KING_CRAB, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_BEACH),
                List.of(new MobSpawnSettings.SpawnerData(EntityTypeRegistry.KING_CRAB.get(), 10, 1, 2))
        ));
        context.register(ADD_SPAWN_ENT, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_FOREST),
                List.of(new MobSpawnSettings.SpawnerData(EntityTypeRegistry.ENT.get(), 5, 1, 2))
        ));
        context.register(ADD_SPAWN_NATURE_GOLEM, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_FOREST),
                List.of(new MobSpawnSettings.SpawnerData(EntityTypeRegistry.NATURE_GOLEM.get(), 5, 1, 2))
        ));
        context.register(ADD_SPAWN_RIVER_GOLEM, new BiomeModifiers.AddSpawnsBiomeModifier(
        ...
        context.register(ADD_SPAWN_SCOURGE, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(net.neoforged.neoforge.common.Tags.Biomes.IS_SWAMP),
                List.of(new MobSpawnSettings.SpawnerData(EntityTypeRegistry.SCOURGE.get(), 45, 1, 2))
        ));
        context.register(ADD_SPAWN_SWAMP_WANDERER, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(net.neoforged.neoforge.common.Tags.Biomes.IS_SWAMP),
                List.of(new MobSpawnSettings.SpawnerData(EntityTypeRegistry.SWAMP_WANDERER.get(), 25, 1, 3))
        ));
        context.register(ADD_SPAWN_DEVIL, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_NETHER),
                List.of(new MobSpawnSettings.SpawnerData(EntityTypeRegistry.DEVIL.get(), 15, 1, 2))
        ));
        context.register(ADD_SPAWN_GOBLIN, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                List.of(new MobSpawnSettings.SpawnerData(EntityTypeRegistry.GOBLIN.get(), 5, 1, 4))
        ));
        context.register(ADD_SPAWN_TROLL, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
                List.of(new MobSpawnSettings.SpawnerData(EntityTypeRegistry.TROLL.get(), 3, 2, 4))
        ));
        context.register(ADD_SPAWN_SORCERER, new BiomeModifiers.AddSpawnsBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_OVERWORLD),
    ...
    private static ResourceKey<BiomeModifier> registerKey(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, Valoria.loc(name));
    }
}
