...
public class FireTrapBlock extends Block{
    ...
    private void activateTrap(Level level, BlockPos pos, Entity entityIn){
        // PORT NOTE: EnchantmentHelper.hasFrostWalker removed; Frost Walker is checked on the boots' enchantment level.
        if(entityIn instanceof LivingEntity living && com.idark.valoria.registries.EnchantmentsRegistry.getLevel(level, living.getItemBySlot(EquipmentSlot.FEET), Enchantments.FROST_WALKER) > 0) return;
