...
public class ParticleMaterialItem extends Item implements ParticleItemEntity, IGuiRenderItem, IGUIParticleItem{
    ...
    // resolved on use; the ParticleType constructor is kept for callers that already have a bound instance.
    public java.util.function.Supplier<? extends ParticleType<?>> particle;
