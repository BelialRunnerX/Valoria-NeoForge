...
public class ValoriaClient{
    ...
    public static final KeyMapping BAG_MENU_KEY = new KeyMapping("key.valoria.bag_menu", KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_B, CATEGORY_KEY);
    ...
    public static void setupClient(final FMLClientSetupEvent event){
        event.enqueueWork(() -> {
            ...
            // PORT NOTE: MenuScreens.register is private in 1.21; screens are registered in RegistryEvents#registerScreens (RegisterMenuScreensEvent).
        });
    }
    ...
    public static class RegistryEvents{
        ...
        // PORT NOTE: RegisterGuiOverlaysEvent -> RegisterGuiLayersEvent; overlays are LayeredDraw.Layers keyed by ResourceLocation.
        @SubscribeEvent
        ...
        public static void OnAddItemDecorators(RegisterItemDecorationsEvent e) {
            // PORT NOTE: Item.isEdible() -> FOOD data component.
        ...
        public static void registerLayers(EntityRenderersEvent.AddLayers event) {
            ...
            PlayerRenderer defaultRenderer = event.getSkin(PlayerSkin.Model.WIDE); // PORT NOTE: skins are keyed by PlayerSkin.Model
