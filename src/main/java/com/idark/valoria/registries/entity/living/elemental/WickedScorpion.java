...
public class WickedScorpion extends MultiAttackMob implements RangedAttackMob, Enemy{
    ...
    public WickedScorpion(EntityType<? extends WickedScorpion> pEntityType, Level pLevel){
        ...
        java.util.Objects.requireNonNull(this.getAttribute(Attributes.STEP_HEIGHT)).setBaseValue(1.0D); // PORT NOTE: setMaxUpStep -> STEP_HEIGHT attribute
    ...
    public class ScorpionSpitAttack extends AttackGoal{
        ...
        public boolean canUse(){
            return super.canUse() && WickedScorpion.this.distanceToSqr(WickedScorpion.this.getTarget()) > 12.0D && isWithinAttackRange(WickedScorpion.this.getTarget(), 12) && WickedScorpion.this.getTarget() instanceof Player;
        }
