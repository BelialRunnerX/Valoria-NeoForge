...
public class VoidSpearItem extends SpearItem{
    ...
    public ItemAttributeModifiers createAttributes(){
        ...
        builder.add(AttributeReg.NIHILITY_DAMAGE, new AttributeModifier(Valoria.BASE_NIHILITY_DAMAGE_ID, 3, AttributeModifier.Operation.ADD_VALUE), EquipmentSlotGroup.MAINHAND);
