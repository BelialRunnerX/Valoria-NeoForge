        ...
        elements.add(new PageElement() {
            ...
            public void init() {
                ...
                if (mc.level != null) {
                    ...
                    .map(RecipeHolder::value) // PORT NOTE: recipes come wrapped in RecipeHolders in 1.21
        ...
        elements.add(new PageElement() {
            ...
            public int render(GuiGraphics gui, int x, int y, int mouseX, int mouseY) {
                ...
                if (entity != null) {
                    ...
                    // PORT NOTE: renderEntityInInventory gained a translation vector parameter in 1.21 (zero keeps the old placement).
