...
public class ModularWeaponItem extends SwordItem {
    ...
    public ModularWeaponItem(Tier tier, int attackDamageModifier, float attackSpeedModifier, Properties properties) {
        super(tier, properties.attributes(SwordItem.createAttributes(tier, attackDamageModifier, attackSpeedModifier))); // PORT NOTE: attributes component replaces the 4-arg ctor
    }
