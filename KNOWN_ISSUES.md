...
- Supporter cloaks (`getSkin()` mixin), Jade/JER pages, HUD layer ordering, entity riding offsets moved to the type builders; KubeJS `heavy_workbench` and `manipulator` schemas (the kiln, jewelry and crusher ones are verified).
