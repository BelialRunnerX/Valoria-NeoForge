...
public abstract class AbstractHauntedMerchant extends Monster implements NeutralMob, InventoryCarrier, ReputationEventHandler, Merchant{
    ...
    public void addAdditionalSaveData(CompoundTag pCompound){
        ...
        // PORT NOTE: MerchantOffers NBT goes through MerchantOffers.CODEC with registry ops in 1.21 (same "Offers" layout);
        // InventoryCarrier read/write take the registry lookup.
