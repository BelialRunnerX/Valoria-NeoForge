...
public class ShurikenProjectile extends AbstractSupplierProjectile{
    public float rotationVelocity = 0;
    public boolean returnToPlayer;

    public ShurikenProjectile(EntityType<? extends ShurikenProjectile> pEntityType, Level pLevel){
        super(pEntityType, pLevel);
    }

    public ShurikenProjectile(LivingEntity pShooter, Level pLevel, ItemStack thrownStackIn){
