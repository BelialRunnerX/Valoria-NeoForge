...
public class KilnBlock extends BaseEntityBlock implements SimpleWaterloggedBlock{
    public static final com.mojang.serialization.MapCodec<KilnBlock> CODEC = simpleCodec(KilnBlock::new); // PORT NOTE: BlockBehaviour#codec() is abstract in 1.21
    @Override protected com.mojang.serialization.MapCodec<? extends KilnBlock> codec(){ return CODEC; }
    ...
    // PORT NOTE: the custom-name copy in setPlacedBy is handled by BlockItem via the CUSTOM_NAME component
    // (BaseContainerBlockEntity#applyImplicitComponents) in 1.21, so the override was removed.
