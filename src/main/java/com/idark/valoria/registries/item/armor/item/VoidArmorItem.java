...
public class VoidArmorItem extends EffectArmorItem{
	public VoidArmorItem(ArmorItem.Type type, Holder<ArmorMaterial> material, Properties properties) {
    ...
    private static final class ArmorRender implements IClientItemExtensions {
        ...
        public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel<?> model) {
            ...
            ModelPart root = models.bakeLayer(slot == EquipmentSlot.LEGS ? ValoriaLayers.VOID_ARMOR_INNER : ValoriaLayers.VOID_ARMOR_OUTER);
