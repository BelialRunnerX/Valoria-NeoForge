...
public class TrollAttackGoal extends MeleeAttackGoal{
    ...
    /**
     * PORT NOTE: MeleeAttackGoal#checkAndPerformAttack lost the squared-distance parameter in 1.20.2+ and the reach check
     * moved into Mob#isWithinMeleeAttackRange (via canPerformAttack), which replaces the old getAttackReachSqr comparison.
     */
    @Override
