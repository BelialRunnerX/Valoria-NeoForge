...
public class SpikeTrapBlock extends DirectionalBlock{
    ...
    public static final com.mojang.serialization.MapCodec<SpikeTrapBlock> CODEC = com.mojang.serialization.codecs.RecordCodecBuilder.mapCodec(i -> i.group(
    ...
    @Override
    protected com.mojang.serialization.MapCodec<? extends SpikeTrapBlock> codec(){
        return CODEC;
    }
