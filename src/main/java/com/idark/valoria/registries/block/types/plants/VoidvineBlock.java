...
public class VoidvineBlock extends BushBlock{
    public static final com.mojang.serialization.MapCodec<VoidvineBlock> CODEC = simpleCodec(VoidvineBlock::new); // PORT NOTE: BlockBehaviour#codec() is abstract in 1.21
    @Override protected com.mojang.serialization.MapCodec<? extends VoidvineBlock> codec(){ return CODEC; }
