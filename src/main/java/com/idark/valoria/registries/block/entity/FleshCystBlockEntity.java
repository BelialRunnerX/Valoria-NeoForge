...
/**
 * PORT NOTE: GameEventListener.Holder -> GameEventListener.Provider, game events are passed as Holders, the experience
 * reward needs the level, and NBT/sync methods carry a HolderLookup.Provider in 1.21.
 */
