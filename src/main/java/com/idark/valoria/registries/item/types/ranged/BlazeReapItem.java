...
/**
 * PORT NOTE: Vanishable was removed. The {@code canApplyAtEnchantingTable} override (WEAPON, DIGGER or the custom BLAZE
 * category) is data now: the item sits in {@code minecraft:enchantable/weapon}, {@code minecraft:enchantable/mining} and
 * {@code valoria:enchantable/blaze} (the Explosive Flame enchantment's supported_items). The {@code "charge"} NBT became
 * the {@code valoria:charge} component.
 */
