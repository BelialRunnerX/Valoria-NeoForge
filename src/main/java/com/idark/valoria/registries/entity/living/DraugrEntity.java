...
public class DraugrEntity extends Monster implements RangedAttackMob{
    ...
    public void performRangedAttack(LivingEntity pTarget, float pDistanceFactor){
        ...
        if(this.getMainHandItem().getItem() instanceof BowItem){
            abstractarrow = ((BowItem)this.getMainHandItem().getItem()).customArrow(abstractarrow, itemstack, this.getMainHandItem()); // PORT NOTE: customArrow takes the projectile and weapon stacks in 1.21
        }
    ...
    protected AbstractArrow getArrow(ItemStack pArrowStack, float pVelocity){
        return ProjectileUtil.getMobArrow(this, pArrowStack, pVelocity, this.getMainHandItem()); // PORT NOTE: getMobArrow takes the firing weapon in 1.21
    }
