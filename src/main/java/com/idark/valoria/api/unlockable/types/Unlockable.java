    ...
    public void award(ServerPlayer pPlayer){
        ...
        if(loot != null){
            for(ResourceLocation resourcelocation : this.loot){
                // PORT NOTE: loot tables are fetched by ResourceKey from the reloadable registries in 1.21.
                for(ItemStack itemstack : pPlayer.server.reloadableRegistries().getLootTable(net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, resourcelocation)).getRandomItems(lootparams)){
