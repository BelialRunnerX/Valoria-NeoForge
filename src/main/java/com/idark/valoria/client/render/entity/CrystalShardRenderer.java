...
public class CrystalShardRenderer extends EntityRenderer<CrystalShard>{
    ...
    public void render(CrystalShard pEntity, float pEntityYaw, float pPartialTicks, @NotNull PoseStack pMatrixStack, @NotNull MultiBufferSource pBuffer, int pPackedLight){
     ...
     */
    public @NotNull ResourceLocation getTextureLocation(@NotNull CrystalShard pEntity){
        return TEXTURE;
    }
}