...
public class ScourgeModel<T extends ScourgeEntity> extends AbstractHierarchicalModel<T>{
    ...
    public void setupAnim(T pEntity, float pLimbSwing, float pLimbSwingAmount, float pAgeInTicks, float pNetHeadYaw, float pHeadPitch){
        ...
        this.animateWalk(ScourgeAnimation.WALK, pLimbSwing, pLimbSwingAmount, 8, 6);
        this.animateIdle(pEntity.idleAnimationState, ScourgeAnimation.IDLE, pLimbSwingAmount, pAgeInTicks, 1);
        this.animate(pEntity.attackAnimationState, ScourgeAnimation.ATTACK_MELEE, pAgeInTicks);
        this.animate(pEntity.diggingAnimationState, ScourgeAnimation.SPAWN, pAgeInTicks);
        this.animate(pEntity.deathAnimationState, ScourgeAnimation.DEATH, pAgeInTicks);
    }
}
