...
public class SarcophagusBlock extends HorizontalDirectionalBlock implements SimpleWaterloggedBlock{
    public static final com.mojang.serialization.MapCodec<SarcophagusBlock> CODEC = simpleCodec(SarcophagusBlock::new); // PORT NOTE: BlockBehaviour#codec() is abstract in 1.21
    @Override protected com.mojang.serialization.MapCodec<? extends SarcophagusBlock> codec(){ return CODEC; }
