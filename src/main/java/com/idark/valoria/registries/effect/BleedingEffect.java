...
/**
 * PORT NOTE: attribute modifiers on effects are identified by ResourceLocation instead of UUID string
 * ({@code valoria:bleeding_speed}); applyEffectTick returns boolean, false removes the effect (immunity curio equipped).
 */
