...
public class QuickSandBlock extends Block{
    ...
    public void entityInside(BlockState pState, Level pLevel, BlockPos pPos, Entity pEntity){
        ...
        if(!(pEntity instanceof LivingEntity) || pEntity.getInBlockState().is(this)){ // PORT NOTE: getFeetBlockState -> getInBlockState
    ...
    @Override
    protected boolean isPathfindable(BlockState pState, PathComputationType pType){ // PORT NOTE: lost the level/pos parameters in 1.21
        return true;
    }
}
