...
public class GolemStompAttack extends AttackInstance{
    ...
    public void performAttack(){
        ...
        ScreenshakeHandler.add(new PositionedScreenshakeInstance(5, Pos3.init((float)vec3.x, (float)vec3.y, (float)vec3.z), 0, 10));
        for(LivingEntity entity : entities){
            ...
            if(sqrt != 0.0D){
                ...
                // PORT NOTE: Blast Protection's knockback dampening is the EXPLOSION_KNOCKBACK_RESISTANCE attribute in 1.21.
