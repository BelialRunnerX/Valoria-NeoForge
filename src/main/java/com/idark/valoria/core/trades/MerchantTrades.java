...
public class MerchantTrades{
    ...
    static class ItemsForItem implements ItemListing{
        ...
        public MerchantOffer getOffer(Entity pTrader, RandomSource pRandom){
            // PORT NOTE: MerchantOffer takes an ItemCost for the price in 1.21.
            return new MerchantOffer(new net.minecraft.world.item.trading.ItemCost(this.currencyStack.getItem(), this.currencyCount), new ItemStack(this.soldStack.getItem(), this.numberOfItems), this.maxUses, this.experience, this.priceMultiplier);
        }
    }
}
