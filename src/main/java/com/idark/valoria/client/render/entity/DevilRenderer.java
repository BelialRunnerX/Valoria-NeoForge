...
public class DevilRenderer extends MobRenderer<Devil, DevilModel<Devil>>{
    protected static final ResourceLocation TEXTURE = Valoria.loc("textures/entity/devil.png");
    protected static final ResourceLocation TEXTURE_ANGER = Valoria.loc("textures/entity/devil_anger.png");
    ...
    public DevilRenderer(EntityRendererProvider.Context context){
        ...
        this.addLayer(new LuminescentLayer.Builder<>(this)
                .setTexture(Valoria.loc("textures/entity/devil_eyes.png"))
