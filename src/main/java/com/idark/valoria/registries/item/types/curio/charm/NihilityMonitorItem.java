...
public class NihilityMonitorItem extends ValoriaCurioItem implements TooltipComponentItem{
    ...
    public Seq<TooltipComponent> getTooltips(ItemStack pStack) {
        ...
        new AbilityComponent(Component.translatable("tooltip.valoria.nihility_monitor").withStyle(ChatFormatting.GRAY), Valoria.loc("textures/gui/tooltips/sound.png"), 6, 0),
        ...
        new TextComponent(Component.translatable("tooltip.valoria.rmb_switch").withStyle(DotStyle.of().font(Valoria.FONT)))
        );
    }
    ...
    // PORT NOTE: "ToggleState" NBT -> valoria:toggle_state component.
