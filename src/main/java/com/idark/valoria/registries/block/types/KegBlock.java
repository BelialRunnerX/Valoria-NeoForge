...
public class KegBlock extends HorizontalDirectionalBlock implements EntityBlock, SimpleWaterloggedBlock{
    public static final com.mojang.serialization.MapCodec<KegBlock> CODEC = simpleCodec(KegBlock::new); // PORT NOTE: BlockBehaviour#codec() is abstract in 1.21
    @Override protected com.mojang.serialization.MapCodec<? extends KegBlock> codec(){ return CODEC; }
