...
public class BossSummonableItem extends TexturedSpawnEggItem{
    ...
    @Override
    public EntityType<?> getType(ItemStack stack){ // PORT NOTE: getType(CompoundTag) -> getType(ItemStack)
    ...
    public AABB getAABB(BlockPos targetPos) {
        ...
        double width = dim.width() + this.expandValue; // PORT NOTE: EntityDimensions is a record in 1.21
