...
public class TieredToolHandler implements ToolHandler{
    ...
    // PORT NOTE: Jade 15's ToolHandler extends IJadeProvider (getUid) and dropped getName(); the name is kept for the uid.
    ...
    public net.minecraft.resources.ResourceLocation getUid() {
        return com.idark.valoria.Valoria.loc("tool_handler/" + name);
    }
