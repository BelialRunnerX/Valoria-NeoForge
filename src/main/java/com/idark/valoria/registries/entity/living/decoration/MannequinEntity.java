...
public class MannequinEntity extends AbstractDecorationMob implements IEntityExtension{ // PORT NOTE: IForgeEntity -> IEntityExtension
    public MannequinEntity(EntityType<? extends Mob> type, Level worldIn){
        super(type, worldIn);
        java.util.Objects.requireNonNull(this.getAttribute(Attributes.STEP_HEIGHT)).setBaseValue(0.0D); // PORT NOTE: setMaxUpStep -> STEP_HEIGHT attribute
    }
