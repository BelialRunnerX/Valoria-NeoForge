 ...
 * HolderLookup.Provider, recipe lookups go through ContainerRecipeInput/RecipeHolder, isSameItemSameTags ->
 * isSameItemSameComponents and ItemStack#hurt -> hurtAndBreak(ServerLevel).
 */
