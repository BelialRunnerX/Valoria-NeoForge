                ...
                for(int j4 = 0; j4 < 3; ++j4){
                    ...
                    if(worldgenlevel.isEmptyBlock(blockpos2)){
                        ...
                        if(j3 == 1){
                            ...
                            // PORT NOTE: RandomizableContainerBlockEntity.setLootTable(level, random, pos, ResourceLocation) -> RandomizableContainer.setBlockEntityLootTable(..., ResourceKey<LootTable>)
                            net.minecraft.world.RandomizableContainer.setBlockEntityLootTable(worldgenlevel, randomsource, blockpos2, net.minecraft.resources.ResourceKey.create(Registries.LOOT_TABLE, Valoria.loc("chests/dungeon")));
                            break;
                        }
                    }
                }
