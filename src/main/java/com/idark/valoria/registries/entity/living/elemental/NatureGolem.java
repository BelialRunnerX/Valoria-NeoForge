...
public class NatureGolem extends AbstractElementalGolem{
    ...
    public @Nullable SpawnGroupData finalizeSpawn(ServerLevelAccessor pLevel, DifficultyInstance pDifficulty, MobSpawnType pReason, @Nullable SpawnGroupData pSpawnData){
        // PORT NOTE: finalizeSpawn no longer receives the spawn-egg NBT; the random variant is always rolled here and a
        // "Variant" entry in the egg's entity data still wins because EntityType applies that tag (load()) afterwards.
