...
- **Intermittent (harness):** in one of seven full runs the Necromancer killed by the player dropped no `necromancer_treasure_bag` (Dryador, Firron and Wicked Crystal always dropped theirs). Not reproduced by hand yet; the harness now logs the entities present at the kill to narrow it down.
