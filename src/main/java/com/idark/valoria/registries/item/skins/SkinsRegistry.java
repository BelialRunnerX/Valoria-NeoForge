...
// PORT NOTE: ModelEvent.ModifyBakingResult exposes Map<ModelResourceLocation, BakedModel> in 1.21 and
// DeferredRegister#getEntries yields DeferredHolder<Item, ? extends Item>.
