...
public class BloodVeinBlock extends MultifaceBlock implements FleshSpreaderBehaviour, SimpleWaterloggedBlock{
    public static final com.mojang.serialization.MapCodec<BloodVeinBlock> CODEC = simpleCodec(BloodVeinBlock::new); // PORT NOTE: BlockBehaviour#codec() is abstract in 1.21
    @Override protected com.mojang.serialization.MapCodec<? extends BloodVeinBlock> codec(){ return CODEC; }
