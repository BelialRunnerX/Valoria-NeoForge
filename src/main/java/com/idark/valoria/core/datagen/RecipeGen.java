...
public class RecipeGen extends RecipeProvider implements IConditionBuilder {
    ...
    private void buildManualRecipes(RecipeOutput pWriter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ItemsRegistry.applePie.get()).pattern("AAA").pattern("///").pattern("XXX").define('/', Ingredient.of(Items.APPLE)).define('A', Ingredient.of(Items.COCOA_BEANS)).define('X', Ingredient.of(Items.MILK_BUCKET)).unlockedBy("has_item", has(Items.APPLE)).save(pWriter, Valoria.loc("apple_pie"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ItemsRegistry.aquariusArrow.get(), 4).pattern(" X ").pattern("XOX").pattern(" X ").define('O', Ingredient.of(ItemsRegistry.oceanicShell.get())).define('X', Ingredient.of(Items.ARROW)).unlockedBy("has_item", has(Items.ARROW)).save(pWriter, Valoria.loc("aquarius_arrow"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockRegistry.bronzeDoor.get(), 3).pattern("//").pattern("//").pattern("//").define('/', Ingredient.of(ItemsRegistry.bronzeIngot.get())).unlockedBy("has_item", has(ItemsRegistry.bronzeIngot.get())).save(pWriter, Valoria.loc("bronze_door"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, BlockRegistry.bronzeGlass.get()).pattern(" / ").pattern("/X/").pattern(" / ").define('/', Ingredient.of(ItemsRegistry.bronzeIngot.get())).define('X', Ingredient.of(Items.GLASS)).unlockedBy("has_item", has(ItemsRegistry.bronzeIngot.get())).save(pWriter, Valoria.loc("bronze_glass"));



        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ItemsRegistry.aquariusMultiTool.get()).requires(Ingredient.of(ItemsRegistry.aquariusPickaxe.get())).requires(Ingredient.of(ItemsRegistry.aquariusAxe.get())).requires(Ingredient.of(ItemsRegistry.aquariusShovel.get())).requires(Ingredient.of(ItemsRegistry.aquariusHoe.get())).unlockedBy("has_item", has(ItemsRegistry.aquariusPickaxe.get())).save(pWriter, Valoria.loc("aquarius_multi_tool"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ItemsRegistry.cobaltMultiTool.get()).requires(Ingredient.of(ItemsRegistry.cobaltPickaxe.get())).requires(Ingredient.of(ItemsRegistry.cobaltAxe.get())).requires(Ingredient.of(ItemsRegistry.cobaltShovel.get())).requires(Ingredient.of(ItemsRegistry.cobaltHoe.get())).unlockedBy("has_item", has(ItemsRegistry.cobaltPickaxe.get())).save(pWriter, Valoria.loc("cobalt_multi_tool"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ItemsRegistry.crimtaneMultiTool.get()).requires(Ingredient.of(ItemsRegistry.crimtanePickaxe.get())).requires(Ingredient.of(ItemsRegistry.crimtaneAxe.get())).requires(Ingredient.of(ItemsRegistry.crimtaneShovel.get())).requires(Ingredient.of(ItemsRegistry.crimtaneHoe.get())).unlockedBy("has_item", has(ItemsRegistry.crimtanePickaxe.get())).save(pWriter, Valoria.loc("crimtane_multi_tool"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ItemsRegistry.voidMultiTool.get()).requires(Ingredient.of(ItemsRegistry.voidPickaxe.get())).requires(Ingredient.of(ItemsRegistry.voidAxe.get())).requires(Ingredient.of(ItemsRegistry.voidShovel.get())).requires(Ingredient.of(ItemsRegistry.voidHoe.get())).unlockedBy("has_item", has(ItemsRegistry.voidPickaxe.get())).save(pWriter, Valoria.loc("void_multi_tool"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ItemsRegistry.natureMultiTool.get()).requires(Ingredient.of(ItemsRegistry.naturePickaxe.get())).requires(Ingredient.of(ItemsRegistry.natureAxe.get())).requires(Ingredient.of(ItemsRegistry.natureShovel.get())).requires(Ingredient.of(ItemsRegistry.natureHoe.get())).unlockedBy("has_item", has(ItemsRegistry.naturePickaxe.get())).save(pWriter, Valoria.loc("nature_multi_tool"));
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ItemsRegistry.infernalMultiTool.get()).requires(Ingredient.of(ItemsRegistry.infernalPickaxe.get())).requires(Ingredient.of(ItemsRegistry.infernalAxe.get())).requires(Ingredient.of(ItemsRegistry.infernalShovel.get())).requires(Ingredient.of(ItemsRegistry.infernalHoe.get())).unlockedBy("has_item", has(ItemsRegistry.infernalPickaxe.get())).save(pWriter, Valoria.loc("infernal_multi_tool"));

        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.DIAMOND), Ingredient.of(ItemsRegistry.goldenRapier.get()), Ingredient.of(Items.DIAMOND), RecipeCategory.MISC, ItemsRegistry.diamondRapier.get()).unlocks("has_item", has(ItemsRegistry.goldenRapier.get())).save(pWriter, Valoria.loc("diamond_rapier"));
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.GOLD_INGOT), Ingredient.of(ItemsRegistry.ironRapier.get()), Ingredient.of(Items.GOLD_INGOT), RecipeCategory.MISC, ItemsRegistry.goldenRapier.get()).unlocks("has_item", has(ItemsRegistry.ironRapier.get())).save(pWriter, Valoria.loc("golden_rapier"));
        
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.GOLD_INGOT), Ingredient.of(ItemsRegistry.ironEyeNecklace.get()), Ingredient.of(Items.GOLD_INGOT), RecipeCategory.MISC, ItemsRegistry.goldenEyeNecklace.get()).unlocks("has_item", has(ItemsRegistry.ironEyeNecklace.get())).save(pWriter, Valoria.loc("golden_eye_necklace"));
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.GOLD_INGOT), Ingredient.of(ItemsRegistry.ironSunNecklace.get()), Ingredient.of(Items.GOLD_INGOT), RecipeCategory.MISC, ItemsRegistry.goldenSunNecklace.get()).unlocks("has_item", has(ItemsRegistry.ironSunNecklace.get())).save(pWriter, Valoria.loc("golden_sun_necklace"));
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.GOLD_INGOT), Ingredient.of(ItemsRegistry.ironMoonNecklace.get()), Ingredient.of(Items.GOLD_INGOT), RecipeCategory.MISC, ItemsRegistry.goldenMoonNecklace.get()).unlocks("has_item", has(ItemsRegistry.ironMoonNecklace.get())).save(pWriter, Valoria.loc("golden_moon_necklace"));
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(Items.GOLD_INGOT), Ingredient.of(ItemsRegistry.ironCelestialNecklace.get()), Ingredient.of(Items.GOLD_INGOT), RecipeCategory.MISC, ItemsRegistry.goldenCelestialNecklace.get()).unlocks("has_item", has(ItemsRegistry.ironCelestialNecklace.get())).save(pWriter, Valoria.loc("golden_celestial_necklace"));
