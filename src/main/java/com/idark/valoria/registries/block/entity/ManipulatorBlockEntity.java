 ...
 * HolderLookup.Provider, recipe lookups go through ContainerRecipeInput/RecipeHolder, and the Forge
 * INBTSerializable round trip in getCoreNBT is replaced by reading the field directly.
 */
public class ManipulatorBlockEntity extends BlockEntity implements MenuProvider, TickableBlockEntity{
    ...
    /** Stored charge for the named core; {@code "empty"} and unknown names yield 0 (they were absent from the old NBT). */
