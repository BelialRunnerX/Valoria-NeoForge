...
/**
 * PORT NOTE: loot tables are addressed by {@code ResourceKey<LootTable>} and resolved through
 * {@code server.reloadableRegistries()} in 1.21; NBT methods carry a HolderLookup.Provider and ItemStacks are
 * (de)serialized with it. The ResourceLocation-based setters are kept for callers.
 */
